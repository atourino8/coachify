<script lang="ts">
  ...
  // --- Progreso: ejercicio cuya gráfica se está mirando ---
  // Por defecto el que más sesiones tiene, que es el que da una curva útil.
    ...
    {#if data.progress.length === 0}
      <div class="card max-w-2xl space-y-3">
        ...
        <p class="text-sm text-text-mute">
          ...
          en cuanto empiece a registrar las series de sus entrenos. Es el dato que convierte "creo que
          va mejor" en "ha subido 12 kg en dos meses".
        </p>
      </div>
    {:else}
      <div class="space-y-6">
